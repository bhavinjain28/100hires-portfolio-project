...
Each expert below meets at least two of:

- Built or scaled outbound at a B2B SaaS company or agency with verifiable client work
- Publishes recent tactical content (2024–2026)
- Shows real artifacts (templates, metrics, infrastructure screenshots)
- Distinct angle across the full pipeline (ICP → list → copy → deliverability → multi-channel → metrics)

## Expert mix

| Archetype | Experts |
|-----------|---------|
| Outbound operators / agencies | Eric Nowoslawski, Jason Bay, Armand Farrokh |
| Signal-based / data outbound | Eric Nowoslawski, Jordan Crawford |
| Copy & messaging | Will Allred, Josh Braun, Kyle Coleman |
| Deliverability & infrastructure | Nils Schneider |
| Multi-channel (email + LinkedIn + phone) | Morgan J Ingram, Kyle Coleman |
| Enterprise playbook | Nick Cegelski |

---

## 1. Eric Nowoslawski

- **Role:** Founder, Growth Engine X (outbound agency; ex-Clay GTM)
...
- **Role:** Founder & Chief GTM Engineer, Blueprint GTM
...
- **Collected:** 2026-06-20
- **Why this voice:** Pioneer of Pain-Qualified Segments (PQS) and Permissionless Value Props (PVP). Works backward from closed deals using public data. Advises Clay, Tennr, and high-growth startups on AI-native outbound.

---

## 3. Will Allred

- **Role:** Co-founder & COO, Lavender (AI email coach used in 30K+ inboxes)
...
- **Role:** CEO, Outbound Squad (trained 20K+ reps at Shopify, Gong, Rippling)
...
- **Role:** Co-founder & CEO, Instantly.ai ($20M+ ARR cold email platform)
...
- **Role:** Co-founder, 30 Minutes to President's Club; ex-VP Sales (Pave, Carta)
...
- **Role:** Founder & CEO, AMP Social (embedded outbound coaching for B2B SaaS)
- **LinkedIn:** https://www.linkedin.com/in/morganjingramamp/
- **YouTube:** https://www.youtube.com/@MorganJIngram (The SDR Chronicles)
- **Collected:** 2026-06-20
- **Why this voice:** 4x LinkedIn Top Sales Voice. $25M+ pipeline created for clients (HubSpot, Slack, AppZen). 10-30-10 video/voice framework for multi-channel outbound beyond email-only playbooks.
...
- **Role:** Co-founder, 30 Minutes to President's Club; 3x #1 enterprise AE
- **LinkedIn:** https://www.linkedin.com/in/nick-cegelski/
- **YouTube:** https://www.youtube.com/@30MPC
- **Collected:** 2026-06-20
- **Why this voice:** Seven-figure deal seller who breaks down world-class cold emails (subject-line personalization, crispy problems, low-friction CTAs). Complements Armand with enterprise deal context and teardown-style content.

---

## Pipeline map (for future playbook synthesis)

```text
ICP + triggers → list/signal sourcing → message/copy → sequence design →
deliverability → reply routing → metrics (reply rate, meetings, pipeline)
```

| Stage | Primary sources |
|-------|-----------------|
| ICP & triggers | Eric Nowoslawski, Jordan Crawford |
| List building | Eric Nowoslawski, Jordan Crawford |
| Copy & messaging | Will Allred, Josh Braun, Jason Bay, Kyle Coleman, Nick Cegelski, Armand Farrokh |
| Sequence design | Jason Bay, Armand Farrokh, Morgan J Ingram |
| Deliverability | Nils Schneider |
| Multi-channel | Morgan J Ingram, Kyle Coleman |
| Metrics & iteration | Eric Nowoslawski, Jason Bay |
